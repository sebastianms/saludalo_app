...
class CausesControllerTest < ActionController::TestCase
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post :create, cause: { network_id: @cause.network_id, owner_id: @cause.owner_id, user_id: @cause.user_id }
    end
  ...
  test "should update cause" do
    put :update, id: @cause, cause: { network_id: @cause.network_id, owner_id: @cause.owner_id, user_id: @cause.user_id }
    assert_redirected_to cause_path(assigns(:cause))
  end
