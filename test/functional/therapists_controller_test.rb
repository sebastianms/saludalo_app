...
class TherapistsControllerTest < ActionController::TestCase
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post :create, therapist: { address: @therapist.address, email: @therapist.email, name: @therapist.name, phone: @therapist.phone, speciality: @therapist.speciality }
    end
  ...
  test "should update therapist" do
    put :update, id: @therapist, therapist: { address: @therapist.address, email: @therapist.email, name: @therapist.name, phone: @therapist.phone, speciality: @therapist.speciality }
    assert_redirected_to therapist_path(assigns(:therapist))
  end
