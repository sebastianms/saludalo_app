...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { network_id: @case.network_id, owner_id: @case.owner_id, user_id: @case.user_id }
    end
  ...
  test "should update case" do
    put :update, id: @case, case: { network_id: @case.network_id, owner_id: @case.owner_id, user_id: @case.user_id }
    assert_redirected_to case_path(assigns(:case))
  end
